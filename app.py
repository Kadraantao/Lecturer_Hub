"""Instructor Hub â€” main entry point.
...
# -------------------- Init DB + seed admin --------------------
init_db()
# ðŸ‘‡ CHANGE THESE VALUES to your own before deploying
seed_admin(
    email="[email protected]",
    password="admin123",
    full_name="Kadra",
...
if st.session_state.user is None and not cookies_ready:
    # Cookies not yet loaded â€” show a subtle loading placeholder
    st.markdown(
        """
        <div style="display:flex; justify-content:center; align-items:center;
            ...
            <div style="text-align:center;">
                ...
                <div style="font-size:1.1rem;">Loadingâ€¦</div>
            </div>
        </div>
        <style>
